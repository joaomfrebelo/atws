...
class Tax
{
    ...
    )
    {
        ...
        AATWs::$logger?->info("Tax type set to " . $this->taxType);
        ...
        AATWs::$logger?->info("TaxCountryRegion was set to " . $this->taxCountryRegion);
        ...
        AATWs::$logger?->info("Tax code set to " . $this->taxCode);
