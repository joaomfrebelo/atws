...
class DeletePayment
{
     ...
     * @param \Rebelo\ATWs\EFaturaMDVersion\Payment\PaymentHeader[]|null $documentList          List of payment documents This field is mutually exclusive with the field “Date Range (dateRange)”. Only one of the fields must be filled in.
