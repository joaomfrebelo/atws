...
class SeriesInformation
{
     ...
     * @param \Rebelo\ATWs\Series\SeriesTypeCode        $seriesTypeCode              Series type code.
     * @param \Rebelo\ATWs\Series\DocumentClassCode     $documentClassCode           Classification code given to the document to which the Series belongs.
     * @param \Rebelo\ATWs\Series\DocumentTypeCode      $documentTypeCode            Series document type code.
    ...
    public function __construct(
        ...
        private DocumentClassCode     $documentClassCode,
